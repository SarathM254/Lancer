...
const Messages = ({ isLoading, profile }) => {
    return (
        <div>
            {profile && <div className='text-2xl font-bold text-white mt-6'>
                Mails
            </div>}
            <div className='my-6'>
                <ul className='text-white bg-[rgba(128,128,128,0.25)] p-5 rounded-2xl space-y-3 mt-5'>
                    {isLoading ? (
                        [...Array(3)].map((_, i) => (
                            <li key={i} className="flex items-center justify-between p-4 text-white rounded-lg animate-pulse">
                                ...
                                <div className="flex items-center gap-4 flex-1">
                                    ...
                                    <div className="flex flex-col md:flex-row md:items-center md:gap-8 flex-1">
                                        ...
                                        <div className="h-4 w-48 bg-gray-600 rounded mt-2 md:mt-0"></div>
                                    </div>
                                </div>
