    ...
    return (
        <div>
            <div className="sidebar text-[rgb(251,251,254)] h-full w-59 flex flex-col">
                <div onClick={() => handleclick(null)} className="flex h-24 bg-[rgba(128,128,128,0.25)] items-center justify-center text-2xl font-bold z-10 shadow-[0_10px_10px_-5px_rgba(0,0,0,0.15)] text-[rgba(50,233,236)] hover:cursor-pointer">
                    Lancer
                </div>
